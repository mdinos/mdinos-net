...
export {
  ...
  throttled as G,
  HALF_PI as H,
  supportsEventListenerOptions as I,
  log10 as J,
  finiteOrDefault as K,
  callback as L,
  toDegrees as M,
  _measureText as N,
  _int16Range as O,
  ...
  retinaScale as a5,
  clearCanvas as a6,
  _elementsEqual as a7,
  getAngleFromPoint as a8,
  _updateBezierControlPoints as a9,
  _filterBetween as aA,
  _lookup as aB,
  getHoverColor as aC,
  fontString as aD,
  clone as aE,
  ...
  TWO_THIRDS_PI as aQ,
  _angleDiff as aR,
  _computeSegments as aa,
  _boundSegments as ab,
  _steppedInterpolation as ac,
  _bezierInterpolation as ad,
  _pointInLine as ae,
  _steppedLineTo as af,
  _bezierCurveTo as ag,
  drawPoint as ah,
  toTRBL as ai,
  toTRBLCorners as aj,
  _boundSegment as ak,
  ...
  getRtlAdapter as am,
  _alignStartEnd as an,
  overrideTextDirection as ao,
  restoreTextDirection as ap,
  _toLeftRightCenter as aq,
  noop as ar,
  distanceBetweenPoints as as,
  toFontString as at,
  _setMinAndMaxByKey as au,
  niceNum as av,
  _decimalPlaces as aw,
  almostEquals as ax,
  almostWhole as ay,
  _longestText as az,
  isArray as b,
